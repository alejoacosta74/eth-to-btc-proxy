...
var errorWalletNotFound = btcjson.RPCError{
	Code:    btcjson.ErrRPCWalletNotFound,
...
// If not, it will import the address and rescan the blockchain for transactions
// related to it.
...
func (q *QtumClient) verifyNodeWallet() error {
	...
	if err != nil {
		if errors.Is(err, errorWalletNotFound) {
